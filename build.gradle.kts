...
val DESC = "Merged javax.annotation:javax.annotation-api and com.google.code.findbugs:jsr305 into a single jar"
val GITHUB_REPO = "RationalityFrontline/javax.annotation-api"

publishing {
    publications {
        create<MavenPublication>("maven") {
            artifact(file("libs/javax.annotation-api-$version-sources.jar")) {
                classifier = "sources"
            }
            artifact(file("libs/javax.annotation-api-$version-javadoc.jar")) {
                classifier = "javadoc"
            }
            artifact(file("libs/javax.annotation-api-$version.jar"))
            pom {
                name.set(NAME)
